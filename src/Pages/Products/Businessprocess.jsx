    ...
    <div className="bg-black relative  ">
      ...
      <div className="mx-15 mt-32">
        <Dropdown
          ...
          percent={"+40%"}
          description={
            "Substantial Operational Efficiency Gains: Streamline and automate key business processes to boost efficiency by as much as 40%, allowing your team to focus on higher-value tasks."
          }
        />
        <Dropdown
          Number={"02"}
          ...
          percent={"+50%"}
          description={
            "Through automation, reduce manual processing costs by up to 50%, optimizing your budget allocation for greater strategic impact."
          }
        />
        <Dropdown
          Number={"03"}
          ...
          percent={""}
          description={
            "Implement workflows that not only meet but exceed customer expectations while fostering a more engaged and productive workforce."
          }
          border={false}
        />
      </div>
