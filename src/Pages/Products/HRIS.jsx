    ...
    <div className="bg-black relative  ">
      ...
      <div className="mx-15 mt-32">
        <Dropdown
          ...
          percent={"+25%"}
          description={
            "Harvard Business Review highlights the importance of data analytics in HR, showing how data-driven decision-making in HR can enhance recruitment efficiency and employee retention by up to 25%"
          }
        />
        <Dropdown
          Number={"02"}
          ...
          percent={"+20%"}
          description={
            "MIT Sloan Management Review emphasizes the role of technology in enabling flexible work arrangements, which can increase employee satisfaction and productivity by up to 20%"
          }
        />
        ...
        <Dropdown
          ...
          percent={"+30%"}
          description={
            "Stanford Graduate School of Business points out the necessity of integrated HR systems for effective talent management, noting that cohesive systems can improve talent development outcomes by 30%"
          }
        />
        <Dropdown
          Number={"04"}
          ...
          percent={"+40%"}
          description={
            " McKinsey & Company underscores the significance of HR automation in reducing administrative tasks, which can free up to 40% of HR professionals' time for strategic initiatives"
          }
        />
        <Dropdown
          Number={"05"}
          ...
          percent={"+35%"}
          description={
            "Deloitte identifies digital HR platforms as key to improving employee experience, with a potential 35% increase in employee engagement scores"
          }
        />
        <Dropdown
          Number={"06"}
          ...
          percent={"+50%"}
          description={
            "The Conference Board discusses the impact of HRIS on workforce planning accuracy, indicating that advanced HRIS can enhance workforce planning effectiveness by up to 50%"
          }
        />
        <Dropdown
          Number={"07"}
          ...
          percent={"+34%"}
          description={
            "Bersin by Deloitte stresses the importance of continuous learning and development, with HRIS-driven programs leading to a 34% improvement in learning outcomes"
          }
        />
        <Dropdown
          Number={"08"}
          ...
          percent={"+40%"}
          description={
            "Gartner focuses on the role of HRIS in supporting diversity and inclusion, finding that technology-enabled D&I initiatives can lead to a more inclusive workplace culture by 45%"
          }
        />
        <Dropdown
          Number={"09"}
          ...
          percent={"+25%"}
          description={
            "Forrester points to the efficiency of self-service HR portals in improving HR service delivery, showing a 25% increase in HR process efficiency"
          }
        />
        <Dropdown
          Number={"10"}
          ...
          percent={"+30%"}
          description={
            "PricewaterhouseCoopers (PwC) showcases the need for mobile HR solutions, with research indicating that mobile access can enhance employee engagement and accessibility by up to 30%"
          }
          border={false}
        />
      </div>
