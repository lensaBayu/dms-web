    ...
    <div className="bg-black relative  ">
      ...
      <div className="mx-15 mt-32">
        <Dropdown
          ...
          percent={"+50%"}
          description={
            "AI-driven analytics provide deeper insights into candidate pools, improving the quality and fit of new hires by up to 50%, as evidenced by industry research"
          }
        />
        <Dropdown
          Number={"02"}
          ...
          percent={"+20%"}
          description={
            "Big Data analytics enable personalized employee engagement strategies, reducing turnover rates by as much as 20% and increasing employee satisfaction significantly."
          }
        />
        <Dropdown
          Number={"03"}
          ...
          percent={"+30%"}
          description={
            "AI and Big Data facilitate more informed decisions regarding talent management, workforce planning, and organizational development, enhancing operational efficiency by over 30%."
          }
          border={false}
        />
      </div>
