    ...
    <div className="bg-black relative  ">
      ...
      <div className="mx-15 mt-32">
        <Dropdown
          ...
          percent={"+40%"}
          description={
            "Achieve a leaner, more agile operation with our strategic approach, potentially increasing your efficiency by up to 40%"
          }
        />
        <Dropdown
          Number={"02"}
          ...
          percent={"+35%"}
          description={
            "Cut through the complexity of IT operations to reduce costs by as much as 35%, enabling more strategic allocation of resources"
          }
        />
        <Dropdown
          Number={"03"}
          ...
          percent={"+100%"}
          description={
            "Stay ahead of the curve with data-driven insights and expert guidance, transforming potential challenges into opportunities for growth."
          }
          border={false}
        />
      </div>
