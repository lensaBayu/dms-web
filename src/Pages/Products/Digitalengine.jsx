    ...
    <div className="bg-black relative  ">
      ...
      <div className="mx-15 mt-32">
        <Dropdown
          ...
          percent={"+20%"}
          description={
            "Streamline your production processes with our digital tools and data insights, potentially boosting your efficiency by up to 20%"
          }
        />
        <Dropdown
          Number={"02"}
          ...
          percent={"+30%"}
          description={
            "Minimize waste and optimize resource allocation to cut operational costs by up to 30%, as evidenced by leading industry researchR"
          }
        />
        <Dropdown
          Number={"03"}
          ...
          percent={"+25%"}
          description={
            "With improved product quality and quicker delivery times, enhance your customer satisfaction levels by up to 25%"
          }
          border={false}
        />
      </div>
