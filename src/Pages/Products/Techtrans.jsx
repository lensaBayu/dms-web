    ...
    <div className="bg-black relative  ">
      ...
      <div className="mx-15 mt-32">
        <Dropdown
          ...
          percent={"++"}
          description={
            "Propel your business forward with cutting-edge technologies that drive innovation, potentially increasing your market share and opening new revenue streams."
          }
        />
        <Dropdown
          Number={"02"}
          ...
          percent={"+40%"}
          description={
            " Implement smarter, technology-driven processes to boost your operational efficiency by up to 40%, as demonstrated by industry leaders, thereby reducing costs and improving service delivery."
          }
        />
        <Dropdown
          Number={"03"}
          ...
          percent={"++"}
          description={
            "Build a more resilient business capable of withstanding digital disruptions and adapting to market changes, ensuring long-term sustainability and growth"
          }
          border={false}
        />
      </div>
