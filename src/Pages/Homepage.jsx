...
function Homepage() {
  ...
  return (
    <div className="bg-black relative">
      ...
      <nav className="absolute top-0 left-0 right-0 z-20 max-w-[1400px] mx-auto">
      ...
      <div className="relative text-white w-full">
        ...
        <div className="absolute top-72  w-full">
          <div className="max-w-[1400px] mx-auto flex-col flex items-start justify-center xl:h-[700px] lg:h-[400px] md:px-[30px]">
            <h1 className="text-7.5xl w-[580px] leading-none font-extralight">
              Empowering your goals with our technology and talent
            </h1>
            <button className="mt-10 border b text-white w-[120px] h-[50px] grid place-content-center">
              Start Here
            </button>
          </div>
        </div>
      ...
      <div ref={cardSectionRef} className=" mt-36 mb-48  gap-3 max-w-[1400px] md:px-[30px] mx-auto">
        <motion.div
        ...
        >
          ...
          <div className="grid place-content-center">
            <Card
              ...
              description={
                "Let’s visualize traditional AI/ML & Generative AI use case in HR Industry"
              }
      ...
      <div className="mb-20 w-full">
        <div className="flex  w-full relative">
          <img src="/Percent1.png" alt="" className="h-[800px]" />
          <div className="flex-1 h-[800px] relative">
            <div className="bg-black w-full h-full absolute z-10 opacity-30"></div>
            <img src="/image2.jpeg" alt="" className="w-full h-full absolute object-cover" />
            <div className="absolute flex items-end text-white font-extralight lg:text-5xl xl:text-7.5xl  leading-none z-10 pb-10 pl-10 h-full">
              <h1 className="xl:w-[600px] lg:w-[400px]">
                our clients are top-rated companies in Indonesia
              </h1>
            </div>
          </div>
        </div>
        <div className="flex flex-row-reverse w-full relative">
          <img src="/Percent2.png" alt="" className="h-[800px]" />
          <div className="flex-1 h-[800px] relative">
            <div className="bg-black w-full h-full absolute z-10 opacity-30"></div>
            <img src="/image3.jpeg" alt="" className="w-full h-full absolute object-cover" />
            <div className="absolute flex flex-col justify-center text-white font-extralight  leading-none z-10 pb-10 pl-10 h-full">
              <h1 className="xl:w-[600px] lg:w-[400px] lg:text-5xl xl:text-7.5xl">
                of them believe our presence delivers ease to their business
              </h1>
              <div className="">
                <button className="mt-10 border bg-white text-black font-medium p-3 px-5 grid">
                  See our impact
                </button>
              </div>
            </div>
        ...
        {/* <div className="flex">
          ...
          <div className="grid place-content-end h-[800px] w-[877px] relative">
            ...
            <div className=" text-white font-extralight text-7.5xl leading-none z-10 pb-10 pl-10 w-[80%]">
              of them believe our presence delivers ease to their business
            </div>
          </div>
        </div>
        ...
        <div className="flex">
          <div className="grid place-content-center h-[800px] w-[877px] relative">
            ...
            <div className=" text-white absolute left-0 top-1/2 font-medium transform -translate-y-1/2 pl-20  z-10 w-[700px] ">
              <div className="text-7.5xl leading-none font-extralight">
                of them believe our presence delivers ease to their business
              </div>
              <button className="mt-10 border bg-white text-black p-3 px-5 grid place-content-center">
                See our impact
              </button>
            </div>
          </div>
